...
# ----------------------------------------- #
# ginza sudachi tinysegmenter sentencepiece #  
# ----------------------------------------- #
# ginza
RUN mkdir /workspace
WORKDIR /workspace
RUN pip install janome sentencepiece tinysegmenter3 "https://github.com/megagonlabs/ginza/releases/download/latest/ginza-latest.tar.gz"
